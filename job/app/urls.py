...
from .views import add_person, check_auth, dashbord, get_person, index, job_list_view, login_view, logout_view, signup, user_list, update_profile, update_password, toggle_apply_job, hr_list,api_jobs
